                ...
                row.map((piece, c) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            {r === 7 && (
                                <span className="absolute bottom-1 right-1 text-black font-bold text-lg">{boardLetters[c]}</span>
                            )}
                            {c === 0 && (
                                <span className="absolute left-1 top-1 text-black font-bold text-lg">{boardNumbers[r]}</span>
                            )}
                        </div>
                    );
                })
